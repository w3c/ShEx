...
\t2 (valueRef \entryFor (arc \entryFor r).valueSpec) \in \dom rules) \land \\
\t1 (r \in \ran rarc \land (rarc \entryFor r).valueSpec \in \ran subjectRef \implies \\
\t2 (subjectRef \entryFor (rarc \entryFor r).valueSpec) \in \dom rules)
\end{schema}
