...
The $ShEx$ language treats \textbf{IRI}s and \textbf{blank nodes} as primitive types, so we can formally define them as $Z$ basic types:
\begin{zed}
[IRI, BlankNode]
\end{zed}
...
\end{itemize}
\end{quote}
We model this by defining $String$ and $LanguageTag$ as basic types:
\begin{zed}
[String, LanguageTag]
\end{zed}
...
purposes, we can simply define it as a separate basic type:
\begin{zed}
[Label]
\end{zed}
